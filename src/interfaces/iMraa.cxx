...
iMraa::iMraa()
{
    printf("Initializing MRAA... %s\n",
            mraa::init() == mraa::SUCCESS ? "passed" : "failed");
            ...
            case 'a':
                {
                    ...
                    {
                        std::cerr << "Failing to initialize Aio from: " +
                            proto_str << std::endl;
                        throw;
                    }
                    break;
            ...
            case 'g':
                {
                    ...
                    {
                        std::cerr << "Failing to initialize Gpio from: " +
                            proto_str << std::endl;
                        throw;
                    }
            ...
            case 'i':
                {
                    ...
                    {
                        std::cerr << "Failing to initialize I2c from: " +
                            proto_str << std::endl;
                        throw;
                    }
                    /* Parse any additional parameters */
